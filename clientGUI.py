...
def search():
    ...
    if(replyRes == "OK"):
        ...
        if(value1 != "Đồng tiền không tồn tại"):
            ...
            label_money_1 = Label(search_screen, text="Giá mua tiền mặt: {} VNĐ".format(
                muatienmat), bg="#556677", fg="white")
            label_money_2 = Label(search_screen, text="Giá bán tiền mặt: {} VNĐ".format(
                bantienmat), bg="#556677", fg="white")
            label_money_3 = Label(search_screen, text="Giá mua chuyển khoản: {} VNĐ".format(
                muack), bg="#556677", fg="white")
            label_money_4 = Label(search_screen, text="Giá bán chuyển khoản: {} VNĐ".format(
                banck), bg="#556677", fg="white")
            label_money_1.pack()
            label_money_2.pack()
            label_money_3.pack()
            label_money_4.pack()
            ...
            label5 = Label(
                search_screen, text="Đồng tiền không tồn tại", bg="#556677", fg="white")
            label5.pack()
